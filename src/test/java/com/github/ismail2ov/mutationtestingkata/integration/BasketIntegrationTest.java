package com.github.ismail2ov.mutationtestingkata.integration;
...
public class BasketIntegrationTest extends BaseTestcontainers {
    ...
    public void when_add_product_to_empty_basket_then_basket_has_1_item() {
        ...
        ResponseEntity<Basket> result = testRestTemplate.postForEntity("/users/" + userId + "/basket", productToAdd, Basket.class);
